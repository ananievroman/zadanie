...
echo " На школьной выставке рисунков красками было $color_pictures <br><br>";
echo "<hr>";


echo "Задание #3 <br><br>";
define("SOME_CONST", 28, true);

if (defined("SOME_CONST")) { //не по psr-2// не понял???
    echo SOME_CONST . "<br>"; //
}

define("SOME_CONST", 29, true);
